...
- 파이썬 응용
    ...
    - 파이썬 GUI 라이브러리
        1. PyQt, PySide: 파이썬 최고의 GUI 라이브러리. Qt라는 C/C++ 사용할 GUI 라이브러리를 Python 용으로 변경
            - 화려한 UI 구성
            - 코딩 다양성
            - 조금 어렵다(파이썬 코드와 분리)
            - Qt가 라이선스 구매필수, 프리웨어로 변경한게 PySide
...
<img src="./image/py01.png" width="400">
